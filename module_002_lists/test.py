...
class TestModule2(unittest.TestCase):
    def test_task_1(self):
        self.assertEqual([5, 95, 95, -25, -35, -65],
                         main.task_1([-99, -19, 47, -21, 24, -48, -18, -97, -2, 5, 10, 95, -92, 95, -25, -35, -30, -65],
                                     5))
        self.assertEqual([52, -72], main.task_1(
            [4, -69, 11, -54, -5, -81, -1, 14, -97, 58, 52, 67, 88, -96, 67, -6, -8, -72, -21, -87, -36], 2))
        self.assertEqual([10, 70, 10], main.task_1([10, 94, -21, 70, -84, -42, -64, -12, -82, 35, 29, -25, 10], 0))
        self.assertEqual([-38, -78], main.task_1([-94, -38, -24, 74, -76, -60, -42, -78, -22, -56, 2, 92, 62], 8))
        self.assertEqual([5], main.task_1([68, -56, 42, 74, 21, -16, 5, 18, 12, -92, 70, 100, 48], 5))
        self.assertEqual([50, -80, 80], main.task_1(
            [-17, 41, 36, 46, -34, -93, -44, 7, -63, -88, 55, 50, -86, -34, 88, 69, -80, 48, -75, -25, 80, 73, -94, -65,
             -98, -69], 0))
        self.assertEqual([18], main.task_1([46, 36, 18, 65, -24, -6], 8))
        self.assertEqual([89, 19], main.task_1(
            [57, -3, -96, -31, 89, -26, -84, -56, 37, -97, -3, -23, -17, 23, 93, 31, 90, 25, -84, 19, -58, 12, -87, -98,
             57], 9))
        self.assertEqual([97], main.task_1([49, 97, 92, 74, 55, -1, -15, -85, -68, 38, 100, 63, -50, 66, -32, -43], 7))
        self.assertEqual([21],
                         main.task_1([34, 21, -84, 90, -48, -62, -60, -5, -13, -87, 17, -14, -10, -4, -24, -62], 1))
        self.assertEqual([26], main.task_1(
            [69, -87, 10, 97, 98, -52, 40, 27, -54, -40, -22, 61, -51, -53, -19, 17, -22, 3, 22, 26, -81, -79, 49, -59,
             -35], 6))
        self.assertEqual([], main.task_1([-16, 71, 31, -71, 88, 5, 12, -53, 23, -2, -4, 66, 22], 0))
        self.assertEqual([48, -98, -38], main.task_1(
            [33, 53, 48, -21, -98, -6, 41, 26, 50, -94, 86, 52, 84, 35, 91, -62, -72, 11, -13, -5, -24, -38, 63], 8))
        self.assertEqual([41, -41, 11], main.task_1([41, 60, -12, 92, -43, -10, -41, 63, 30, 11, 22, -9], 1))
        self.assertEqual([-61, 81], main.task_1([-61, -35, -97, 94, 55, 81], 1))
        self.assertEqual([25], main.task_1([-36, -60, -54, 25, 63, -99], 5))
        self.assertEqual([-22], main.task_1([-22, 1, 14, -3, 100, -13], 2))
        self.assertEqual([-17], main.task_1([-60, -17, -48, -80, 96, 34, -19, -13, -22, 55, 82, 69, 86, -11], 7))
        self.assertEqual([], main.task_1([87, -80, 53, 88, -5, -19, -6, -35], 2))
        self.assertEqual([], main.task_1([0, 43, 78, -66, -96, -7, -9, -55, -69], 4))
        self.assertEqual([-47],
                         main.task_1([75, 21, 63, -48, -74, 70, -86, -47, 39, 31, -15, -58, -93, 100, -24, 30, 60, -76],
                                     7))
        self.assertEqual([], main.task_1([99, -80, -75, -81, 39], 2))
        self.assertEqual([], main.task_1([-39, -82, 79, -2, 43, 82, 70, -68, 81, -55, 96, -73, -79, -32, -32, -97], 4))
        self.assertEqual([26, -36, 16, -76, 6, -26, -26, 56, -96], main.task_1(
            [26, -44, -5, -36, 73, -14, 41, 19, 60, 16, -76, -44, 6, 4, 8, -99, -26, -26, -29, -100, 34, -79, 56, -53,
             54, 11, -91, -75, -96], 6))
        self.assertEqual([2, 72, -2],
                         main.task_1([-55, 87, 26, -89, 50, 2, 72, -53, -5, -98, -7, -2, -53, -71, 27, 33], 2))
        self.assertEqual([-32, -22, -32],
                         main.task_1([49, -32, 38, 97, -22, -32, -24, -45, -16, 97, -58, 94, 35, -76, -8, 66, 49, -40],
                                     2))
        self.assertEqual([-46, -6, 16, 36], main.task_1(
            [-41, -64, -98, 61, 54, -33, -46, -8, 53, -48, 62, 54, 50, 21, -6, 16, 61, 100, -21, 78, -73, 44, 36, -12],
            6))
        self.assertEqual([38], main.task_1([-2, 34, -70, -23, 22, 27, -89, -1, 54, -20, 30, -21, 16, 38, -24, -72], 8))
        self.assertEqual([-26], main.task_1([38, -64, -90, -26, 3, 2, 55, 33, 65, -74, 33, 51, -88], 6))
        self.assertEqual([], main.task_1([-70, 15, 3, 98, -67, -49, 96, -7, -23, 15], 2))
    ...
    def test_task_5(self):
        self.assertEqual([150, 180, 61, 11, 2, -14, -144, -167, -177, 167],
                         main.task_5([61, -14, 11, 150, -167, -177, 180, 167, -144, 2]))
        self.assertEqual(
            [-121, -21, -21, -192, -152, 33, -3, 54, -64, -34, -4, -115, -35, 26, 177, -157, -198, 8, -128, 148, 139,
             -189], main.task_5(
                [33, 54, -3, -192, -121, 26, -198, -21, -115, 139, -21, 177, 8, -189, -64, -152, -157, -35, -34, -4,
                 -128, 148]))
        self.assertEqual([50, -171, 111, -182, -22, -43, -43, 53, 194, -94, 188, 49],
                         main.task_5([194, -182, 188, 49, 50, -171, -43, -43, 111, 53, -94, -22]))
        self.assertEqual(
            [100, -20, -60, -41, 62, -142, 142, 83, 54, -175, -135, -155, 155, -196, -176, -196, 76, -67, -117, -118,
             78, -98, 38, -29, 169], main.task_5(
                [-67, 100, 83, -175, -196, -176, 62, -118, -41, -135, -142, -20, 54, -117, 78, -98, -29, -155, 38, -60,
                 169, 142, 155, -196, 76]))
        self.assertEqual([160, 121, 121, 41, 142, -154, 15, -75, 27, -58, 118, 109],
                         main.task_5([-58, 121, 27, 15, 160, 142, -154, -75, 121, 118, 41, 109]))
        self.assertEqual([-110, 180, -151, -113, 184, 195, -125, -125, 17, 137, 157, -188, 128, 89],
                         main.task_5([89, -188, 17, -110, 180, 195, 137, 184, -125, 128, -113, -151, -125, 157]))
        self.assertEqual(
            [200, 61, -92, -32, 112, -102, 73, 83, -143, -193, 64, 85, 85, -125, 166, 197, 167, -7, 87, 47, -77, -38,
             -188, 189, 119], main.task_5(
                [189, 197, -38, 167, 73, 64, -188, 83, -7, -143, 85, -92, 119, -32, -193, 85, 200, 87, 47, 112, 166,
                 -125, 61, -102, -77]))
        self.assertEqual([-120, -151, 162, 125, -195, -166, 26, -97, 178, -58, -199, -169],
                         main.task_5([125, -166, 178, 26, -97, -120, -151, -58, -199, 162, -195, -169]))
        self.assertEqual(
            [120, -30, -41, 61, -81, -64, -184, 44, 185, 5, -65, -5, -86, 7, 68, 138, -118, 118, 169, -189, -69, 129,
             129], main.task_5(
                [68, 138, -64, 185, -118, -41, 61, 118, 5, -65, -81, 120, 169, -189, -5, -30, -69, -86, -184, 129, 129,
                 7, 44]))
        self.assertEqual(
            [100, -50, -161, 182, 142, -73, -23, 154, 24, 194, -44, -175, -86, -47, -67, -8, -38, 99, -99, -19],
            main.task_5(
                [-73, 182, -161, 100, 154, -86, -23, 24, 99, -50, -99, -19, 194, -44, 142, -175, -47, -8, -67, -38]))
        self.assertEqual(
            [120, 130, 11, 33, -103, -74, 174, -64, 115, 185, -116, -166, -86, -76, 97, 137, 118, -198, -68, -59, -49,
             -149], main.task_5(
                [118, -74, 115, -116, 33, -59, -49, 120, 174, -149, -166, 185, -198, -68, 130, -64, 97, 11, 137, -86,
                 -76, -103]))
        self.assertEqual([-90, 70, 161, -122, 142, 164, 55, 56, 187, 77, 28, -149, 9],
                         main.task_5([187, -90, 70, 55, 56, -149, 161, 9, 28, 164, 77, -122, 142]))
        self.assertEqual([-170, 141, -62, 93, -73, -83, -84, 36, -36, -16, 37, 89],
                         main.task_5([37, -84, 93, -73, -83, 36, -36, -62, 89, -170, -16, 141]))
        self.assertEqual([-10, 122, 112, 83, -33, 174, -196, 27, -199, -79],
                         main.task_5([174, 122, -10, 83, 27, 112, -33, -196, -199, -79]))
        self.assertEqual([-90, 110, -130, 121, 22, -72, -172, 72, 183, 143, -113, -46, 166, -167, 47, -108, 138, 79],
                         main.task_5(
                             [183, -90, -46, -167, 110, 47, -130, 22, -72, 79, -108, 166, 121, -172, 138, 143, -113,
                              72]))
        self.assertEqual([50, -200, 50, 20, 161, -191, 172, -23, 43, 175, -55, 195, -15, 66, 88, 48, 29, 29],
                         main.task_5(
                             [50, -200, 161, 29, 175, 66, -55, 172, 195, 29, -23, 43, -191, 50, 88, 48, 20, -15]))
        self.assertEqual(
            [190, 91, -192, -82, 72, -23, -13, 143, 145, 126, -156, -156, 17, 128, -8, 18, -118, -158, 19, 69],
            main.task_5(
                [190, 128, 91, -8, -23, 18, 145, 126, -192, 19, -82, -13, -118, 69, 17, -156, 143, 72, -156, -158]))
        self.assertEqual([-181, 41, -142, 32, 95, 75, -15, -116, -168, -128, 69, 149],
                         main.task_5([69, 149, -168, -142, 95, -116, -128, -181, 75, 41, -15, 32]))
        self.assertEqual(
            [30, 90, 20, -111, -121, 111, 21, 71, -22, -123, 24, -164, -105, -75, 187, -7, 128, -79, 9, -79, 159],
            main.task_5(
                [-111, 187, -79, 128, 9, 24, 30, -121, -123, -22, -164, 90, 111, -105, 21, 71, -7, -79, 20, 159, -75]))
        self.assertEqual([-200, -30, 71, 161, -192, 92, 123, -184, -174, 25, 67, 187, 168, -118, 128, 79, -149],
                         main.task_5(
                             [123, -200, -184, -30, -192, 168, -118, 67, 79, 187, 128, 71, 25, 161, 92, -174, -149]))
